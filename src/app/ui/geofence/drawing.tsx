...
import { createGeofence, deleteGeofenceLocation, searchGeofence } from "@/app/lib/geofence-utils";
...
const Drawing = () => {
    ...
    const overlayCompleteListener = google.maps.event.addListener(
      ...
      (drawResult: any) => {
        ...
        const newShape = {
          ...
          radius: drawResult.type === google.maps.drawing.OverlayType.CIRCLE ? drawResult.overlay.getRadius() : null, // Store radius
        };

        google.maps.event.addListener(newShape.overlay, 'radius_changed', () => {
  ...
  const deleteSelectedShape = () => {
    ...
    //TODO delete from DB with the name ${selectedShape.name}
  };
  ...
  return (
    <>
      ...
      <Map
        ...
        // }}
      />
      <div className="relative shadow-md z-10 mt-2 flex space-x-4 rounded-lg mb-4">
        <Button onClick={saveShapes}>Save</Button>
        <Button onClick={deleteSelectedShape} className="bg-red-500 hover:bg-red-400 active:bg-red-600">Delete</Button>
      </div>
      </div>
